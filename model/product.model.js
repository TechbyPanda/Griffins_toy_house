...
//       pool.getConnection((err,con)=>{
//         if(!err){
//            let sql = "select categories.category_name,product.pname,product.product_price,product.product_stock,product.description,product.date from product inner join categories on categories.id=product.category_id where product.id=?";
